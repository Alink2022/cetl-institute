      ...
      cards: [
        {
          ...
          tagline: "Maßgeschneiderte KI- & Daten-Grundlage mit praktischer Befähigung",
          description: "Ein strukturiertes Einstiegsangebot, das grundlegenden Kompetenzaufbau mit Business-Kontext und realer Anwendung verbindet.",
          includes: [
            { icon: "GraduationCap", text: "Grundlegendes KI- & Daten-Lernen" },
            { icon: "Users", text: "Rollen- und kontextspezifische Anpassung" },
            { icon: "Target", text: "Strategische Ausrichtung und Use-Case-Framing" },
            { icon: "BookOpen", text: "Zugang zu akademischer und expertengestützter Umsetzung" },
          ],
          footer: [{ icon: "ShieldCheck", text: "Fundament für die unternehmensweite Aktivierung" }],
        },
        {
          number: "2",
          ribbon: "MOST POPULAR",
          ...
          tagline: "Foundation plus rollenbasierte Vertiefung und praktische Anwendung",
          description: "Ein flexibles Paket für Organisationen, die Lernen in funktionsspezifische Kompetenzentwicklung übersetzen wollen.",
          includes: [
            { icon: "CheckCircle2", text: "Alles aus der Foundation-Ebene" },
            { icon: "User", text: "Rollenspezifische Spezialisierungspfade" },
            { icon: "Star", text: "Erweiterte Executive- und Experten-Lernformate" },
            { icon: "BarChart2", text: "Projektorientierte Befähigung und Mentoring" },
          ],
          footer: [
            { icon: "Layers", text: "Foundation-Ebene" },
            { icon: "Share2", text: "Spezialisierungs-Ebene" },
          ],
        },
        {
          number: "3",
          ...
          tagline: "Eingebettete Aktivierung für Umsetzung, Adoption und messbaren Fortschritt",
          description: "Für Organisationen, die bereit sind, vom Lernen zur praktischen Umsetzung mit eingebetteter Unterstützung überzugehen.",
          includes: [
            { icon: "Layers", text: "Alles aus Paket 1 + 2" },
            { icon: "Settings2", text: "Eingebettete Engineering- und Umsetzungsunterstützung" },
            { icon: "Share2", text: "Prototyping, Workflow-Integration und Aktivierung" },
            { icon: "Users", text: "Starker Wissenstransfer in interne Teams" },
          ],
          footer: [{ icon: "Target", text: "Umsetzungsunterstützung nah an der Arbeit" }],
        },
        {
          number: "4",
          ribbon: "COMMUNITY",
          ...
          tagline: "Community-gestützte Co-Creation für KI-, Daten- und Innovationsherausforderungen",
          description: "Aktiviert das breitere Ökosystem, um Ideen gemeinsam zu entwickeln, zu verfeinern und zu beschleunigen.",
          includes: [
            { icon: "Handshake", text: "Teilnahme an unserem Flaggschiff-Hackathon mit Partnern wie Stadt Wien, Vienna Business Agency, ÖBB, Sustainista u. a." },
            { icon: "UsersRound", text: "Dedizierte Workshops und Community-Sessions vor und nach dem Hackathon" },
            { icon: "Lightbulb", text: "Zugang zu einer der größten Daten- & KI-Communities im DACH-Raum, vernetzt mit 15+ Universitäten" },
            { icon: "Rocket", text: "Ideal für Kollaboration, Challenge-Framing, Validierung und frühen Schwung" },
          ],
          footer: [{ icon: "UsersRound", text: "Community-gestützte Zusammenarbeit für echten Innovationsschwung" }],
        },
      ],
    },
    {
      ...
      cards: [
        {
          ...
          tagline: "Von realer Umsetzung zu einer skalierbaren Assessment-Praxis",
          description: "Baut auf CETLs Executional-Learning-, Advisory- und Challenge-basierten Formaten auf.",
          includes: [
            { icon: "Target", text: "Erfasst Leistungssignale unter realen Arbeitsbedingungen" },
            { icon: "Users", text: "Baut auf CETLs Executional-Learning-, Advisory- und Challenge-Formaten auf" },
            { icon: "ClipboardCheck", text: "Verwandelt Beobachtung in strukturiertes Kompetenzurteil" },
            { icon: "ShieldCheck", text: "Schafft eine zweite strategische Säule ohne große neue Infrastruktur" },
          ],
        ...
        },
        {
          ...
          description: "Bewertung anhand realer Business Cases statt inszenierter Übungen.",
          includes: [
            { icon: "Briefcase", text: "Bewertung durch reale Business Cases, keine inszenierten Übungen" },
            { icon: "FileText", text: "Transparenter Zweck, transparente Kriterien und Ergebnisverwendung" },
            { icon: "Map", text: "Organisationsweite Kompetenzsicht für Advance-, Develop- oder Redeploy-Entscheidungen" },
            { icon: "Users", text: "Relevant für Transformation, Nachfolge, PE- und Sponsor-Kontexte" },
          ],
        ...
        },
        {
          ...
          tagline: "Ein strukturierter Weg von der Baseline zur Kompetenz-Roadmap",
          description: "Baseline-Abgleich, Scope-Definition und Stakeholder-Kalibrierung.",
          includes: [
            { icon: "Calendar", text: "Baseline-Abgleich, Scope-Definition und Stakeholder-Kalibrierung" },
            { icon: "Search", text: "Eingebettetes Assessment durch reale Delivery-Beobachtungen" },
            { icon: "Map", text: "Evidenzbasiertes Capability-Mapping und Advisory-Synthese" },
            { icon: "Users", text: "Multi-Assessor-Perspektive mit akademischer Rigorosität" },
          ],
        ...
        },
        {
          ...
          description: "Unabhängige Drittperspektive, weniger anfällig für interne Politik.",
          includes: [
            { icon: "ShieldCheck", text: "Unabhängige Drittperspektive, weniger anfällig für interne Politik" },
            { icon: "Scale", text: "Transparent und nachvollziehbar konzipiert" },
            { icon: "TrendingUp", text: "Vorausschauend, da Kompetenz in Aktion beobachtet wird" },
            { icon: "Euro", text: "Ein Engagement kann sowohl Audit-Einsicht als auch Entwicklungsschwung freisetzen" },
          ],
