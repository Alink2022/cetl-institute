...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Developed through the strategic synergy of CETL Institute and community partners — insight and networking convert into measurable delivery outcomes.",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="flex flex-col gap-6">
            {FEATURES.map((feature, i) => (
              <div
                key={feature.title}
                className="flex gap-6 p-6 bg-cetl-dark border border-cetl-border hover:border-cetl-gold/30 transition-colors duration-300"
              >
